...
## Technology
Is a simple system with an REST API at the backend and a web application as a fronted. No database is needed, just memory for the moment.
...
### Configuration
- This file with main guidelines at `/AGENTS.md`
