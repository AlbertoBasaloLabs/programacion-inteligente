...
- **¿Cómo dividir una especificación en trabajo ejecutable?**
  - Las especificaciones completas son demasiado grandes para abordarlas de una vez.
...
- **Planificación de tareas**:
  - Dividir especificaciones en tareas manejables.
  - Definir dependencias y orden de ejecución.
  - Establecer criterios de completitud para cada tarea.
- **Ramas de desarrollo**:
  - Usar ramas de Git para aislar el trabajo.
  - Una rama por tarea o conjunto relacionado de tareas.
